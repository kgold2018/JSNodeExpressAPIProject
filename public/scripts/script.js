    ...
    static async deleteUser() {
        ...
        class AppService {
            static getAppName() {
                //return fetch("http://localhost:5000/api/")
                 return fetch("https://jsnodeexpressapiproject.onrender.com/api/")
                    .then(response => {
        ...
        class UserService {
            static async getUsers() {
                return fetch("https://jsnodeexpressapiproject.onrender.com/api/users/")
            ...
            static async postUsers(firstName, lastName, age) {
                ...
                try {
                    const response = await fetch(
                        "https://jsnodeexpressapiproject.onrender.com/api/users/",
                ...
                try {
                    const response = await fetch(
                       ...
                       // `http://localhost:5000/api/users/${user.id}`,
                        `https://jsnodeexpressapiproject.onrender.com/api/users/${user.id}`,
                        {
                            method: 'PATCH',
                            headers: {
                                'Content-Type': 'application/json',
            ...
            static async deleteUsers(id) {
                ...
                try {
                    const response = await fetch(
                        `https://jsnodeexpressapiproject.onrender.com/api/users/${id}`,
...
//we are on tab edit
        if (formEdit !== null) {
            ...
            editButton.addEventListener('click', async () => {
               //await UserService.patchUsers(user);
               await UI.editUser();
               UI.clearLocalStorage();
